...
class LSM6DSL
{
	...
	public:
		...
		LSM6DSL_INTF_RET_TYPE setBigLittleEndian(LSM6DSL_ENDIAN end);

		LSM6DSL_INTF_RET_TYPE setAllIRQonINT1(uint8_t en);

		LSM6DSL_INTF_RET_TYPE INT1SourceConfig(LSM6DSL_INT1_Sources s);

		LSM6DSL_INTF_RET_TYPE INT2SourceConfig(LSM6DSL_INT2_Sources s);

		LSM6DSL_INTF_RET_TYPE toggleBlockDataUpdate(uint8_t m);

		LSM6DSL_INTF_RET_TYPE toggleDataReadyMask(uint8_t m);

		LSM6DSL_INTF_RET_TYPE setAccelODR(LSM6DSL_XL_ODR m);

		LSM6DSL_INTF_RET_TYPE setAccelFSRange(LSM6DSL_XL_FS_Range r);

		LSM6DSL_INTF_RET_TYPE isAccelDataAvailabe();

		LSM6DSL_INTF_RET_TYPE setAccelHighPerfMode(LSM6DSL_XL_G_HM_MODE m);
		...
		LSM6DSL_INTF_RET_TYPE configAccelDigitalLPF(LSM6DSL_XL_LPF_BW bw, uint8_t LNLL);

		LSM6DSL_INTF_RET_TYPE configAccelDigitalHPF(LSM6DSL_XL_HPF_BW bw);

		LSM6DSL_INTF_RET_TYPE setGyroODR(LSM6DSL_G_ODR m);

		LSM6DSL_INTF_RET_TYPE setGyroFSRange(LSM6DSL_G_FS_Range r);

		LSM6DSL_INTF_RET_TYPE isGyroDataAvailabe();

		LSM6DSL_INTF_RET_TYPE setGyroHighPerfMode(LSM6DSL_XL_G_HM_MODE m);

		LSM6DSL_INTF_RET_TYPE readGyroData(LSM6DSL_GyroRawData *gy);

		LSM6DSL_INTF_RET_TYPE selfTestGyro();

		LSM6DSL_INTF_RET_TYPE configGyroHPF(LSM6DSL_G_HPF_BW bw);
